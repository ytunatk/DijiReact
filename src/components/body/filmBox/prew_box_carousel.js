...
import PrewBox from './prew_box';
function PrewBoxCarousel(props) {
    const genres = {
        "genres": [
            {
                "id": 1,
    ...
    return (
        genres.genres.map((movie) => (
            <div className='prew_box_car'>
                <div>
                    <div className='owl_item_title'>
                        <h3> {movie.name.toUpperCase()} </h3>
                    </div>
                    <div className='owl_item'>
                        <PrewBox movies={movie.movies} />
                    </div>
                </div>
            </div>
        ))
...
export default PrewBoxCarousel;
